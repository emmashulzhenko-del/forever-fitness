...
const trainers: Trainer[] = [
  {
    name: 'Наталя Пустовіт',
    specialty: 'ПЕРСОНАЛЬНИЙ ТРЕНЕР',
    exp: 'Досвід: 25+ років',
  ...
  {
    name: 'Оксана Сидун',
    specialty: 'ПЕРСОНАЛЬНИЙ ТРЕНЕР · FITMAMA',
    exp: 'Досвід: 10+ років',
  ...
  },
  {
    ...
    specialty: 'ТАБАТА · TRX · ПЕРСОНАЛЬНИЙ ТРЕНЕР',
    exp: 'Досвід: 5+ років',
  ...
  },
  {
    ...
    specialty: 'ПЕРСОНАЛЬНИЙ ТРЕНЕР · БОЙОВІ МИСТЕЦТВА',
    exp: 'Досвід: 6+ років',
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col">
                <div className="space-y-1">
                  <p className="font-display text-xl text-zinc-900 dark:text-white leading-snug">
